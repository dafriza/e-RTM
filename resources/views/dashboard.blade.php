            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column">
                        <a href="{{ asset('#') }}" class="d-flex align-items-center border-bottom pb-3">
                            <div class="mr-3">
                                <img src="{{ asset('https://via.placeholder.com/35x35') }}" class="rounded-circle wd-35"
                                    alt="user">
                            </div>
                            <div class="w-100">
                        ...
                        <a href="{{ asset('#') }}" class="d-flex align-items-center border-bottom py-3">
                            <div class="mr-3">
                                <img src="{{ asset('https://via.placeholder.com/35x35') }}" class="rounded-circle wd-35"
                                    alt="user">
                            </div>
