            ...
            <div class="col-12 grid-margin">
                <div class="profile-header">
                    <div class="cover">
                        ...
                        <figure>
                            <img src="{{ asset('https://via.placeholder.com/1148x272') }}" class="img-fluid"
                                alt="profile cover">
                        </figure>
                        <div class="cover-body d-flex justify-content-between align-items-center">
                            <div>
                                <img class="profile-pic" src="{{ asset('https://via.placeholder.com/100x100') }}"
                                    alt="profile">
                    ...
                    <div class="header-links">
                        <ul class="links d-flex align-items-center mt-3 mt-md-0">
                            <li class="header-link-item d-flex align-items-center active">
                                ...
                                <a class="pt-1px d-none d-md-block" href="{{ asset('#') }}">Timeline</a>
                            </li>
                            <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
                                <i class="mr-1 icon-md" data-feather="user"></i>
                                <a class="pt-1px d-none d-md-block" href="{{ asset('#') }}">About</a>
                            </li>
                            <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
                                <i class="mr-1 icon-md" data-feather="users"></i>
                                <a class="pt-1px d-none d-md-block" href="{{ asset('#') }}">Friends
                                    <span class="text-muted tx-12">3,765</span></a>
                            </li>
                            <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
                                <i class="mr-1 icon-md" data-feather="image"></i>
                                <a class="pt-1px d-none d-md-block" href="{{ asset('#') }}">Photos</a>
                            </li>
                            <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
                                <i class="mr-1 icon-md" data-feather="video"></i>
                                <a class="pt-1px d-none d-md-block" href="{{ asset('#') }}">Videos</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item d-flex align-items-center" href="{{ asset('#') }}"><i
                    ...
                    <div class="col-md-12 grid-margin">
                        <div class="card rounded">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <img class="img-xs rounded-circle"
                                            src="{{ asset('https://via.placeholder.com/37x37') }}" alt="">
                                        <div class="ml-2">
                                            <p>Mike Popescu</p>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                            <a class="dropdown-item d-flex align-items-center"
                                                href="{{ asset('#') }}"><i data-feather="meh"
                                                    class="icon-sm mr-2"></i> <span class="">Unfollow</span></a>
                                            <a class="dropdown-item d-flex align-items-center"
                                                href="{{ asset('#') }}"><i data-feather="corner-right-up"
                                                    class="icon-sm mr-2"></i> <span class="">Go to
                                                    post</span></a>
                                            <a class="dropdown-item d-flex align-items-center"
                                                href="{{ asset('#') }}"><i data-feather="share-2"
                                                    class="icon-sm mr-2"></i> <span class="">Share</span></a>
                                            <a class="dropdown-item d-flex align-items-center"
                                                href="{{ asset('#') }}"><i data-feather="copy"
                            ...
                            <div class="card-body">
                                ...
                                <img class="img-fluid" src="{{ asset('https://via.placeholder.com/513x342') }}"
                                    alt="">
                            </div>
                            <div class="card-footer">
                                <div class="d-flex post-actions">
                                    ...
                                    <a href="{{ asset('javascript:;') }}" class="d-flex align-items-center text-muted">
                                ...
                                <div class="latest-photos">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <figure>
                                                <img class="img-fluid"
                                                    src="{{ asset('https://via.placeholder.com/67x67') }}"
                                                    alt="">
                                            </figure>
                                        </div>
                                        <div class="col-md-4">
